...
document.getElementById("sketch-to-be-drawn_name").innerHTML = "Sketch to be drawn : " + sketch;
var timer_counter = 0;
var timer_check = "";
var drawn_sketch = "";
var answer_holder = "";
...
function update_canvas() {
    ...
    document.getElementById("sketch-to-be-drawn_name").innerHTML = "Sketch to be drawn : " + sketch;
    document.getElementById("sketch_name").innerHTML = "Your Sketch : ";
    document.getElementById("confidence_name").innerHTML = "Confidence : ";
}
...
function gotResult(error ,results) {
    ...
    document.getElementById("confidence_name").innerHTML = "Confidence : " + Math.round(results[0].confidence * 100) + '%';
}